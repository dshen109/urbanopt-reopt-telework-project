...
class HVAC
  def self.apply_central_ac_1speed(model, unit, runner, seer, eers, shrs,
    ...
    obj_name = WholeBuildingConstants.ObjectNameCentralAirConditioner(unit.name.to_s)

    thermal_zones = WholeBuildingGeometry.get_thermal_zones_from_spaces(unit.spaces)
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ...
      if capacity != WholeBuildingConstants.SizingAuto
      ...
      air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCapacityDerateFactorEER, eer_capacity_derates.join(","))
      air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACRatedCFMperTonCooling, cfms_ton_rated.join(","))
      air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracCoolLoadServed, frac_cool_load_served)
    end # control_zone
  ...
  def self.apply_central_ac_2speed(model, unit, runner, seer, eers, shrs,
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ...
      # Store info for HVAC Sizing measure
      air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCapacityRatioCooling, capacity_ratios.join(","))
      air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCapacityDerateFactorEER, eer_capacity_derates.join(","))
      air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACRatedCFMperTonCooling, cfms_ton_rated.join(","))
      air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracCoolLoadServed, frac_cool_load_served)
    end # control_zone
  ...
  def self.apply_central_ashp_1speed(model, unit, runner, seer, hspf, eers, cops, shrs,
    ...
    if heat_pump_capacity == WholeBuildingConstants.SizingAutoMaxLoad
      runner.registerWarning("Using #{WholeBuildingConstants.SizingAutoMaxLoad} is not recommended for single-speed heat pumps. When sized larger than the cooling load, this can lead to humidity concerns due to reduced dehumidification performance by the heat pump.")
    end
    ...
    obj_name = WholeBuildingConstants.ObjectNameAirSourceHeatPump(unit.name.to_s)
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ...
      if heat_pump_capacity != WholeBuildingConstants.SizingAuto and heat_pump_capacity != WholeBuildingConstants.SizingAutoMaxLoad
      ...
      if supplemental_capacity != WholeBuildingConstants.SizingAuto
      ...
      # Store info for HVAC Sizing measure
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCapacityDerateFactorEER, eer_capacity_derates.join(","))
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCapacityDerateFactorCOP, cop_capacity_derates.join(","))
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHPSizedForMaxLoad, (heat_pump_capacity == WholeBuildingConstants.SizingAutoMaxLoad))
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACRatedCFMperTonHeating, cfms_ton_rated_heating.join(","))
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACRatedCFMperTonCooling, cfms_ton_rated_cooling.join(","))
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracHeatLoadServed, frac_heat_load_served)
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracCoolLoadServed, frac_cool_load_served)
    end # control_zone
  ...
  def self.apply_central_ashp_2speed(model, unit, runner, seer, hspf, eers, cops, shrs,
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ...
      perf.setSingleModeOperation(false)
      for speed in 1..num_speeds
        f = OpenStudio::Model::SupplyAirflowRatioField.new(fan_speed_ratios_heating[speed - 1], WholeBuildingConstants.small)
        perf.addSupplyAirflowRatioField(f)
      end
      ...
      perf.setSingleModeOperation(false)
      for speed in 1..num_speeds
        f = OpenStudio::Model::SupplyAirflowRatioField.new(WholeBuildingConstants.small, fan_speed_ratios_cooling[speed - 1])
        perf.addSupplyAirflowRatioField(f)
      end
      ...
      # Store info for HVAC Sizing measure
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCapacityRatioCooling, capacity_ratios.join(","))
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCapacityRatioHeating, capacity_ratios.join(","))
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCapacityDerateFactorEER, eer_capacity_derates.join(","))
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCapacityDerateFactorCOP, cop_capacity_derates.join(","))
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHPSizedForMaxLoad, (heat_pump_capacity == WholeBuildingConstants.SizingAutoMaxLoad))
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACRatedCFMperTonHeating, cfms_ton_rated_heating.join(","))
  ...
  def self.apply_mshp(model, unit, runner, seer, hspf, shr,
    ...
    obj_name = WholeBuildingConstants.ObjectNameMiniSplitHeatPump(unit.name.to_s)
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ...
      mshp_indices.each do |mshp_index|
        ...
        f = OpenStudio::Model::SupplyAirflowRatioField.new(ratio, WholeBuildingConstants.small)
        perf.addSupplyAirflowRatioField(f)
      end
      ...
      if pan_heater_power > 0
        ...
        thermal_zones.each do |thermal_zone|
          if WholeBuildingGeometry.is_living(thermal_zone)
      ...
      mshp_indices.each do |mshp_index|
        ...
        f = OpenStudio::Model::SupplyAirflowRatioField.new(WholeBuildingConstants.small, ratio)
        perf.addSupplyAirflowRatioField(f)
      end
      ...
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.DuctedInfoMiniSplitHeatPump, is_ducted)
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.DuctedInfoMiniSplitHeatPump, is_ducted)
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCapacityRatioHeating, capacity_ratios_heating_4.join(","))
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCapacityRatioCooling, capacity_ratios_cooling_4.join(","))
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACHeatingCFMs, cfms_heating_4.join(","))
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCoolingCFMs, cfms_cooling_4.join(","))
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACHeatingCapacityOffset, heating_capacity_offset)
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHPSizedForMaxLoad, (heat_pump_capacity == WholeBuildingConstants.SizingAutoMaxLoad))
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACSHR, shrs_rated_4.join(","))
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracHeatLoadServed, frac_heat_load_served)
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracCoolLoadServed, frac_cool_load_served)
    end # control_zone
  ...
  def self.apply_gshp(model, unit, runner, weather, cop, eer, shr,
    ...
    if frac_glycol == 0
      fluid_type = WholeBuildingConstants.FluidWater
      runner.registerWarning("Specified #{fluid_type} fluid type and 0 fraction of glycol, so assuming #{WholeBuildingConstants.FluidWater} fluid type.")
    end
    ...
    obj_name = WholeBuildingConstants.ObjectNameGroundSourceHeatPumpVerticalBore(unit.name.to_s)
    ...
    if fluid_type == WholeBuildingConstants.FluidWater
      plant_loop.setFluidType('Water')
    else
      plant_loop.setFluidType({ WholeBuildingConstants.FluidPropyleneGlycol => 'PropyleneGlycol', WholeBuildingConstants.FluidEthyleneGlycol => 'EthyleneGlycol' }[fluid_type])
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ...
      if heat_pump_capacity != WholeBuildingConstants.SizingAuto
      ...
      # Store info for HVAC Sizing measure
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACSHR, shr.to_s)
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoGSHPCoil_BF_FT_SPEC, cOIL_BF_FT_SPEC.join(","))
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoGSHPCoilBF, coilBF)
      htg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracHeatLoadServed, frac_heat_load_served)
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracCoolLoadServed, frac_cool_load_served)
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoGSHPBoreSpacing, bore_spacing)
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoGSHPBoreHoles, bore_holes)
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoGSHPBoreDepth, bore_depth)
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoGSHPBoreConfig, bore_config)
      clg_air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoGSHPUTubeSpacingType, u_tube_spacing_type)
    end
  ...
  def self.apply_room_ac(model, unit, runner, eer, shr,
    ...
    obj_name = WholeBuildingConstants.ObjectNameRoomAirConditioner(unit.name.to_s)
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ([control_zone] + slave_zones).each do |zone|
        ...
        # Store info for HVAC Sizing measure
        ptac.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACCoolingCFMs, airflow_rate.to_s)
        ptac.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACRatedCFMperTonCooling, cfms_ton_rated.join(","))
        ptac.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracCoolLoadServed, frac_cool_load_served)
      end # zone
    end # control_zone
  ...
  def self.apply_furnace(model, unit, runner, fuel_type, afue,
    ...
    furnaceParasiticElecDict = { WholeBuildingConstants.FuelTypeGas => 76.0, # W during operation
                                 WholeBuildingConstants.FuelTypePropane => 76.0,
                                 WholeBuildingConstants.FuelTypeOil => 220.0,
                                 WholeBuildingConstants.FuelTypeElectric => 0.0 }
    aux_elec = furnaceParasiticElecDict[fuel_type]

    # _processAirSystem

    obj_name = WholeBuildingConstants.ObjectNameFurnace(fuel_type, unit.name.to_s)
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ...
      if fuel_type == WholeBuildingConstants.FuelTypeElectric
      ...
      air_loop_unitary.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracHeatLoadServed, frac_heat_load_served)
    end
  ...
  def self.apply_boiler(model, unit, runner, fuel_type, system_type, afue,
    ...
    if system_type == WholeBuildingConstants.BoilerTypeSteam
    ...
    # Parasitic Electricity (Source: DOE. (2007). Technical Support Document: Energy Efficiency Program for Consumer Products: "Energy Conservation Standards for Residential Furnaces and Boilers". www.eere.energy.gov/buildings/appliance_standards/residential/furnaces_boilers.html)
    boilerParasiticElecDict = { WholeBuildingConstants.FuelTypeGas => 76.0, # W during operation
                                WholeBuildingConstants.FuelTypePropane => 76.0,
                                WholeBuildingConstants.FuelTypeOil => 220.0,
                                WholeBuildingConstants.FuelTypeElectric => 0.0 }
    ...
    boiler_eff_curve = get_boiler_curve(model, system_type == WholeBuildingConstants.BoilerTypeCondensing)

    obj_name = WholeBuildingConstants.ObjectNameBoiler(fuel_type, unit.name.to_s)
    ...
    if system_type == WholeBuildingConstants.BoilerTypeCondensing
    ...
    if system_type == WholeBuildingConstants.BoilerTypeCondensing and oat_reset_enabled
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ([control_zone] + slave_zones).each do |zone|
        ...
        # Store info for HVAC Sizing measure
        baseboard_heater.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracHeatLoadServed, frac_heat_load_served)
      end
    end
  ...
  def self.apply_electric_baseboard(model, unit, runner, efficiency, capacity, frac_heat_load_served)
    ...
    obj_name = WholeBuildingConstants.ObjectNameElectricBaseboard(unit.name.to_s)
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ([control_zone] + slave_zones).each do |zone|
        ...
        # Store info for HVAC Sizing measure
        htg_coil.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracHeatLoadServed, frac_heat_load_served)
      end
    end
  ...
  def self.apply_unit_heater(model, unit, runner, fuel_type,
    ...
    obj_name = WholeBuildingConstants.ObjectNameUnitHeater(fuel_type, unit.name.to_s)
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ([control_zone] + slave_zones).each do |zone|
        ...
        # Store info for HVAC Sizing measure
        unitary_system.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACRatedCFMperTonHeating, airflow_rate.to_s)
        unitary_system.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracHeatLoadServed, frac_heat_load_served)
      end
    end
  ...
  def self.apply_ideal_air_loads_cooling(model, unit, runner, frac_cool_load_served)
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ([control_zone] + slave_zones).each do |zone|
        ...
        # Store info for HVAC Sizing measure
        ideal_air.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracHeatLoadServed, frac_cool_load_served)
      end
    end
  ...
  def self.apply_ideal_air_loads_heating(model, unit, runner, frac_heat_load_served)
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ([control_zone] + slave_zones).each do |zone|
        ...
        # Store info for HVAC Sizing measure
        ideal_air.additionalProperties.setFeature(WholeBuildingConstants.SizingInfoHVACFracHeatLoadServed, frac_heat_load_served)
      end
    end
  ...
  def self.apply_heating_setpoints(model, runner, weather, htg_wkdy_monthly, htg_wked_monthly,
    ...
    model.getThermalZones.each do |thermal_zone|
      if WholeBuildingGeometry.zone_is_finished(thermal_zone)
    ...
    model.getScheduleRulesets.each do |sch|
      next unless sch.name.to_s == WholeBuildingConstants.ObjectNameHeatingSetpoint
    ...
    finished_zones.each do |finished_zone|
      ...
      if thermostat_setpoint.is_initialized
        ...
        model.getScheduleRulesets.each do |sch|
          next unless sch.name.to_s == WholeBuildingConstants.ObjectNameCoolingSetpoint

          sch.remove
        end
      else # no thermostat in model yet

        clg_wkdy_monthly = [[UnitConversions.convert(WholeBuildingConstants.DefaultCoolingSetpoint, "F", "C")] * 24] * 12
        clg_wked_monthly = [[UnitConversions.convert(WholeBuildingConstants.DefaultCoolingSetpoint, "F", "C")] * 24] * 12
    ...
    (0..11).to_a.each do |i|
      if heating_season[i] == 1 and cooling_season[i] == 1 # overlap seasons
        ...
        htg_wkdy = [UnitConversions.convert(WholeBuildingConstants.DefaultHeatingSetpoint, "F", "C")] * 24
        htg_wked = [UnitConversions.convert(WholeBuildingConstants.DefaultHeatingSetpoint, "F", "C")] * 24
        clg_wkdy = [UnitConversions.convert(WholeBuildingConstants.DefaultCoolingSetpoint, "F", "C")] * 24
        clg_wked = [UnitConversions.convert(WholeBuildingConstants.DefaultCoolingSetpoint, "F", "C")] * 24
      end
    ...
    heating_setpoint = HourlyByMonthSchedule.new(model, runner, WholeBuildingConstants.ObjectNameHeatingSetpoint, htg_wkdy_monthly, htg_wked_monthly, normalize_values = false, create_sch_object = true, winter_design_day_sch = winter_design_day_sch, summer_design_day_sch = summer_design_day_sch)
    cooling_setpoint = HourlyByMonthSchedule.new(model, runner, WholeBuildingConstants.ObjectNameCoolingSetpoint, clg_wkdy_monthly, clg_wked_monthly, normalize_values = false, create_sch_object = true, winter_design_day_sch = winter_design_day_sch, summer_design_day_sch = summer_design_day_sch)
  ...
  def self.apply_cooling_setpoints(model, runner, weather, clg_wkdy_monthly, clg_wked_monthly,
    ...
    heating_season = get_season(model, weather, runner, WholeBuildingConstants.ObjectNameHeatingSeason)

    # Remove existing cooling season schedule
    model.getScheduleRulesets.each do |sch|
      next unless sch.name.to_s == WholeBuildingConstants.ObjectNameCoolingSeason

      sch.remove
    end

    cooling_season_sch = MonthWeekdayWeekendSchedule.new(model, runner, WholeBuildingConstants.ObjectNameCoolingSeason, Array.new(24, 1), Array.new(24, 1), cooling_season, mult_weekday = 1.0, mult_weekend = 1.0, normalize_values = false, create_sch_object = true, winter_design_day_sch = nil, summer_design_day_sch = nil, schedule_type_limits_name = WholeBuildingConstants.ScheduleTypeLimitsOnOff)
    ...
    if finished_zones.length == 0
      runner.registerError("No finished thermal zones found.")
      return false
    end
    ...
    finished_zones.each do |finished_zone|
      ...
      if thermostat_setpoint.is_initialized
        ...
        runner.registerInfo("No existing thermostat in #{finished_zone.name}")
        htg_wkdy_monthly = [[UnitConversions.convert(WholeBuildingConstants.DefaultHeatingSetpoint, "F", "C")] * 24] * 12
        htg_wked_monthly = [[UnitConversions.convert(WholeBuildingConstants.DefaultHeatingSetpoint, "F", "C")] * 24] * 12
  ...
  def self.get_season(model, weather, runner, sch_name)
    ...
    if season.empty?
      ...
      if sch_name == WholeBuildingConstants.ObjectNameHeatingSeason
  ...
  def self.apply_dehumidifier(model, unit, runner, energy_factor,
    ...
    if water_removal_rate != WholeBuildingConstants.Auto and water_removal_rate.to_f <= 0
      runner.registerError("Invalid water removal rate value entered.")
      return false
    end
    if energy_factor != WholeBuildingConstants.Auto and energy_factor.to_f < 0
      runner.registerError("Invalid energy factor value entered.")
      return false
    end
    if air_flow_rate != WholeBuildingConstants.Auto and air_flow_rate.to_f < 0
      runner.registerError("Invalid air flow rate value entered.")
      return false
    end

    obj_name = WholeBuildingConstants.ObjectNameDehumidifier(unit.name.to_s)
    ...
    relative_humidity_setpoint_sch.setName(WholeBuildingConstants.ObjectNameRelativeHumiditySetpoint(unit.name.to_s))
    ...
    control_slave_zones_hash.each do |control_zone, slave_zones|
      ...
      if water_removal_rate != WholeBuildingConstants.Auto
        zone_hvac.setRatedWaterRemoval(UnitConversions.convert(water_removal_rate.to_f, "pint", "L"))
      else
        zone_hvac.setRatedWaterRemoval(WholeBuildingConstants.small) # Autosize flag for HVACSizing measure
      end
      if energy_factor != WholeBuildingConstants.Auto
        zone_hvac.setRatedEnergyFactor(energy_factor.to_f)
      else
        zone_hvac.setRatedEnergyFactor(WholeBuildingConstants.small) # Autosize flag for HVACSizing measure
      end
      if air_flow_rate != WholeBuildingConstants.Auto
        zone_hvac.setRatedAirFlowRate(UnitConversions.convert(air_flow_rate.to_f, "cfm", "m^3/s"))
      else
        zone_hvac.setRatedAirFlowRate(WholeBuildingConstants.small) # Autosize flag for HVACSizing measure
      end
  ...
  def self.remove_dehumidifier(runner, model, zone, unit)
    ...
    model.getScheduleWholeBuildingConstants.each do |sch|
      next unless sch.name.to_s == WholeBuildingConstants.ObjectNameRelativeHumiditySetpoint(unit.name.to_s)
  ...
  def self.apply_ceiling_fans(model, unit, runner, coverage, specified_num, power,
    ...
    obj_name = WholeBuildingConstants.ObjectNameCeilingFan(unit.name.to_s)

    num_bedrooms, num_bathrooms = WholeBuildingGeometry.get_unit_beds_baths(model, unit, runner)
    if num_bedrooms.nil? or num_bathrooms.nil?
      return false
    end

    above_grade_finished_floor_area = WholeBuildingGeometry.get_above_grade_finished_floor_area_from_spaces(unit.spaces, runner)
    finished_floor_area = WholeBuildingGeometry.get_finished_floor_area_from_spaces(unit.spaces, runner)

    # Determine geometry for spaces and zones that are unit specific
    living_zone = nil
    finished_basement_zone = nil
    WholeBuildingGeometry.get_thermal_zones_from_spaces(unit.spaces).each do |thermal_zone|
      if WholeBuildingGeometry.is_living(thermal_zone)
        living_zone = thermal_zone
      elsif WholeBuildingGeometry.is_finished_basement(thermal_zone)
    ...
    if control == WholeBuildingConstants.CeilingFanControlSmart
    ...
    if clg_wkdy_monthly.nil? and clg_wked_monthly.nil?
      runner.registerWarning("No cooling setpoint schedule found. Assuming #{WholeBuildingConstants.DefaultCoolingSetpoint} F for ceiling fan operation.")
      clg_wkdy_monthly = [[WholeBuildingConstants.DefaultCoolingSetpoint] * 24] * 12
      clg_wked_monthly = [[WholeBuildingConstants.DefaultCoolingSetpoint] * 24] * 12
    end
    ...
    unit.spaces.each do |space|
      next if WholeBuildingGeometry.space_is_unfinished(space)
  ...
  def self.get_default_eae(has_boiler, has_furnace, fuel, load_frac, furnace_capacity_kbtuh)
    ...
    eae = nil
    if has_boiler
      if fuel == WholeBuildingConstants.FuelTypeGas or fuel == WholeBuildingConstants.FuelTypePropane
        eae = 170.0 * load_frac # kWh/yr
      elsif fuel == WholeBuildingConstants.FuelTypeOil
  ...
  def self.calc_coil_stage_data_cooling(model, outputCapacity, speeds, cooling_eirs, shrs_rated_gross, cOOL_CAP_FT_SPEC, cOOL_EIR_FT_SPEC, cOOL_CLOSS_FPLR_SPEC, cOOL_CAP_FFLOW_SPEC, cOOL_EIR_FFLOW_SPEC, curves_in_ip, distributionSystemEfficiency)
    ...
    speeds.each_with_index do |speed, i|
      ...
      stage_data = OpenStudio::Model::CoilCoolingDXMultiSpeedStageData.new(model,
                                                                           ...
                                                                           cool_plf_fplr_curve,
                                                                           const_biquadratic)
      if outputCapacity != WholeBuildingConstants.SizingAuto and outputCapacity != WholeBuildingConstants.SizingAutoMaxLoad
  ...
  def self.get_control_and_slave_zones(thermal_zones)
    ...
    finished_above_grade_zones, finished_below_grade_zones = WholeBuildingGeometry.get_finished_above_and_below_grade_zones(thermal_zones)
    control_zone = nil
    slave_zones = []
  ...
  def self.num_central_ac(model, runner, thermal_zone)
    ...
    unitary_system_air_loops.each do |unitary_system_air_loop|
      system, clg_coil, htg_coil, air_loop = unitary_system_air_loop
      next unless system.name.to_s.start_with? WholeBuildingConstants.ObjectNameCentralAirConditioner
  ...
  def self.num_ashp(model, runner, thermal_zone)
    ...
    unitary_system_air_loops.each do |unitary_system_air_loop|
      system, clg_coil, htg_coil, air_loop = unitary_system_air_loop
      next unless system.name.to_s.start_with? WholeBuildingConstants.ObjectNameAirSourceHeatPump
  ...
  def self.num_gshp(model, runner, thermal_zone)
    ...
    unitary_system_air_loops.each do |unitary_system_air_loop|
      system, clg_coil, htg_coil, air_loop = unitary_system_air_loop
      next unless system.name.to_s.start_with? WholeBuildingConstants.ObjectNameGroundSourceHeatPumpVerticalBore
  ...
  def self.num_furnace(model, runner, thermal_zone)
    ...
    unitary_system_air_loops.each do |unitary_system_air_loop|
      system, clg_coil, htg_coil, air_loop = unitary_system_air_loop
      next unless system.name.to_s.start_with? WholeBuildingConstants.ObjectNameFurnace
  ...
  def self.num_mshp(model, runner, thermal_zone)
    ...
    unitary_system_air_loops.each do |unitary_system_air_loop|
      system, clg_coil, htg_coil, air_loop = unitary_system_air_loop
      next unless system.name.to_s.start_with? WholeBuildingConstants.ObjectNameMiniSplitHeatPump
  ...
  def self.has_ducted_mshp(model, runner, thermal_zone)
    ...
    unitary_system_air_loops.each do |unitary_system_air_loop|
      ...
      is_ducted = system.additionalProperties.getFeatureAsBoolean(WholeBuildingConstants.DuctedInfoMiniSplitHeatPump).get
      return is_ducted
    end
    return false
  end
  ...
  def self.remove_boiler(model, runner, thermal_zone, unit)
    ...
    [WholeBuildingConstants.FuelTypeGas, WholeBuildingConstants.FuelTypeOil, WholeBuildingConstants.FuelTypePropane, WholeBuildingConstants.FuelTypeElectric].each do |fuel_type|
      obj_name = WholeBuildingConstants.ObjectNameBoiler(fuel_type, unit.name.to_s)
      model.getEnergyManagementSystemSensors.each do |sensor|
  ...
  def self.prioritize_zone_hvac(model, runner, zone, load_distribution_scheme = "SequentialLoad")
    zone_hvac_list = []
    WholeBuildingConstants.ZoneHVACPriorityList.each do |zone_hvac_type|
  ...
  def self.calc_mshp_cfms_ton_cooling(cap_min_per, cap_max_per, cfm_ton_min, cfm_ton_max, num_speeds, dB_rated, wB_rated, shr)
    ...
    ao = Psychrometrics.CoilAoFactor(dB_rated, wB_rated, WholeBuildingConstants.Patm, UnitConversions.convert(1, "ton", "kBtu/hr"), cfm_ton_nom, shr)
    ...
    (0...num_speeds).each do |i|
      ...
      shrs_rated[i] = [Psychrometrics.CalculateSHR(dB_rated, wB_rated, WholeBuildingConstants.Patm, UnitConversions.convert(capacity_ratios_cooling[i], "ton", "kBtu/hr"), cfms_cooling[i], ao), 0.98].min
    end
